...
#categories = [flavour]
categories = []
categories.append(flav for flav in flavour)

plots_for_branches = []
if "basic" in branch_families:
    plots_for_branches += ["mjj", "basic"]
if "forSkimmer" in branch_families:
    plots_for_branches += ["forSkimmer"]
