...
def main():
    ...
    for cat in categories:
        ...
        line_mjj_1 = ROOT.TLine(60,0,60,1000)
        line_mjj_2 = ROOT.TLine(300,0,300,1000)
        line_mlljj_1 = ROOT.TLine(0,100,1000,100)
        line_mlljj_2 = ROOT.TLine(0,400,1000,400)
        ...
        with open("../scripts_ZA/ellipsesScripts/ellipseParam_{0}.json".format(cat)) as f:
            ...
            for (mbb, mllbb, a_squared, b_squared, theta_rad, mA, mH) in parameters:
                ...
                for e in ell_list:
                    ...
                    c2.cd()
                    e.Draw("same")
                c.SaveAs("DYplusEllipses_nobtag/DYplane_nobtag_{0}_ell_{1}_{2}.png".format(cat, mH, mA), "png")
